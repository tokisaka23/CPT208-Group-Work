...
const backgroundImage = computed(() => liuyuanPanoramaCoverFallback || scenes.value[0]?.fallbackImage || garden.value.heroImage);
const backgroundImageFallback = computed(() => liuyuanPanoramaCover || scenes.value[0]?.image || garden.value.heroImage);
...
@media (max-width: 640px) {
  ...
  .liuyuan-panorama-entry__spotlight-list::-webkit-scrollbar {
    display: none;
  }
