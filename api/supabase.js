...
function getSupabaseEnv() {
  return {
    supabaseUrl: process.env.SUPABASE_URL || process.env.VITE_FY_SUPABASE_URL || '',
    supabaseAnonKey: process.env.SUPABASE_ANON_KEY || process.env.VITE_FY_SUPABASE_ANON_KEY || '',
